...
#if defined( WIN32 )
	{ VideoSystem::BINK,		PLATFORM_WIN32,											"valve_avi_client",	VIDEO_SUBSYSTEM_INTERFACE_VERSION },
#else
	{ VideoSystem::BINK,		PLATFORM_OSX | PLATFORM_XBOX_360 | PLATFORM_LINUX,		"video_bink",	    VIDEO_SUBSYSTEM_INTERFACE_VERSION },
#endif
