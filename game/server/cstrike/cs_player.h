...
#define DHF_HOSTAGE_INJURED		( 1 << 1 )
#define DHF_HOSTAGE_KILLED		( 1 << 2 )
#define DHF_FRIEND_INJURED		( 1 << 3 )
#define DHF_FRIEND_KILLED		( 1 << 4 )
#define DHF_IN_RESCUE_ZONE		( 1 << 5 )
#define	DHF_NIGHTVISION			( 1 << 6 )
#define	DHF_HOSTAGE_CTMOVE		( 1 << 7 )
...
public:
	...
	void Radio( const char *szRadioSound, const char *szRadioText = NULL, bool bTriggeredAutomatically = false, float *flLength = NULL );
...
private:
	void			AddToRebuy( CSWeaponID weaponId );
